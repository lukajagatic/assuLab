...
public class LabNet implements NeuralNetListener {
	...
	public LabNet(int inputNeurons, int hiddenNeurons, int outputNeurons, String patternsFile, String outputFile) {
	...
	public void trainNetwork(String patternsFile, String outputFile, double learningRate, double moment,
			int cycles, int numberOfPatterns) {
